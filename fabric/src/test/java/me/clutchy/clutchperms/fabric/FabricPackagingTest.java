...
/**
 * Verifies the Fabric jar carries the SQLite runtime dependencies ClutchPerms owns.
 */
class FabricPackagingTest {

    @Test
    void fabricJarBundlesHikariAndCanonicalSqliteJdbc() throws IOException {
