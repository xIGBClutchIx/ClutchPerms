...
/**
 * Verifies the NeoForge jar carries the SQLite runtime dependencies ClutchPerms owns.
 */
class NeoForgePackagingTest {

    @Test
    void neoforgeJarBundlesHikariAndCanonicalSqliteJdbc() throws IOException {
