...
final class NeoForgeDisplayComponentsTest {

    private static final UUID SUBJECT_ID = UUID.fromString("00000000-0000-0000-0000-000000000104");
    ...
    private String chatLineText() {
        return NeoForgeDisplayComponents.chatLine(SUBJECT_ID, Component.literal("Target"), Component.literal("hello"), displayResolver).getString();
    }
}
