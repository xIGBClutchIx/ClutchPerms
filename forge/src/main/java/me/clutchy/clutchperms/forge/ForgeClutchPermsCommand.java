...
final class ForgeClutchPermsCommand {
    ...
    static com.mojang.brigadier.builder.LiteralArgumentBuilder<CommandSourceStack> create(Supplier<PermissionService> permissionService,
        ...
        return ClutchPermsCommands.builder(new ForgeCommandEnvironment(permissionService, subjectMetadataService, groupService, trackService, permissionNodeRegistry,
