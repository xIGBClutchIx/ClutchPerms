...
final class ForgeDisplayComponentsTest {

    private static final UUID SUBJECT_ID = UUID.fromString("00000000-0000-0000-0000-000000000103");
    ...
    private String chatLineText() {
        return ForgeDisplayComponents.chatLine(SUBJECT_ID, Component.literal("Target"), Component.literal("hello"), displayResolver).getString();
    }
}
