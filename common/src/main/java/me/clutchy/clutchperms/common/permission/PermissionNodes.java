...
public final class PermissionNodes {
    ...
    private static final List<String> COMMAND_NODES = List.of(ADMIN_HELP, ADMIN_STATUS, ADMIN_RELOAD, ADMIN_VALIDATE, ADMIN_CONFIG_VIEW, ADMIN_CONFIG_SET, ADMIN_CONFIG_RESET,
            ...
            ADMIN_GROUP_DELETE, ADMIN_GROUP_RENAME, ADMIN_GROUP_VIEW, ADMIN_GROUP_GET, ADMIN_GROUP_SET, ADMIN_GROUP_CLEAR, ADMIN_GROUP_PARENTS, ADMIN_GROUP_PARENT_ADD,
            ADMIN_GROUP_PARENT_REMOVE, ADMIN_GROUP_DISPLAY_VIEW, ADMIN_GROUP_DISPLAY_SET, ADMIN_GROUP_DISPLAY_CLEAR, ADMIN_USERS_LIST, ADMIN_USERS_SEARCH, ADMIN_NODES_LIST,
            ADMIN_NODES_SEARCH, ADMIN_NODES_ADD, ADMIN_NODES_REMOVE);
