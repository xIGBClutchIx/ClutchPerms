...
public final class PermissionNodes {
    ...
    public static final String ADMIN_HISTORY = ADMIN + ".history";

    public static final String ADMIN_UNDO = ADMIN + ".undo";
    ...
    public static final String ADMIN_BACKUP_CREATE = ADMIN + ".backup.create";
    ...
    public static final String ADMIN_USER_CLEAR_ALL = ADMIN + ".user.clear-all";
    ...
    public static final String ADMIN_GROUP_INFO = ADMIN + ".group.info";
    ...
    public static final String ADMIN_GROUP_RENAME = ADMIN + ".group.rename";
    ...
    public static final String ADMIN_GROUP_CLEAR_ALL = ADMIN + ".group.clear-all";

    public static final String ADMIN_GROUP_MEMBERS = ADMIN + ".group.members";
    ...
    private static final List<String> COMMAND_NODES = List.of(ADMIN_HELP, ADMIN_STATUS, ADMIN_RELOAD, ADMIN_VALIDATE, ADMIN_HISTORY, ADMIN_UNDO, ADMIN_CONFIG_VIEW,
            ADMIN_CONFIG_SET, ADMIN_CONFIG_RESET, ADMIN_BACKUP_LIST, ADMIN_BACKUP_CREATE, ADMIN_BACKUP_RESTORE, ADMIN_USER_INFO, ADMIN_USER_LIST, ADMIN_USER_GET, ADMIN_USER_SET,
            ADMIN_USER_CLEAR, ADMIN_USER_CLEAR_ALL, ADMIN_USER_CHECK, ADMIN_USER_EXPLAIN, ADMIN_USER_GROUPS, ADMIN_USER_GROUP_ADD, ADMIN_USER_GROUP_REMOVE, ADMIN_USER_DISPLAY_VIEW,
            ADMIN_USER_DISPLAY_SET, ADMIN_USER_DISPLAY_CLEAR, ADMIN_GROUP_LIST, ADMIN_GROUP_INFO, ADMIN_GROUP_CREATE, ADMIN_GROUP_DELETE, ADMIN_GROUP_RENAME, ADMIN_GROUP_VIEW,
            ADMIN_GROUP_GET, ADMIN_GROUP_SET, ADMIN_GROUP_CLEAR, ADMIN_GROUP_CLEAR_ALL, ADMIN_GROUP_MEMBERS, ADMIN_GROUP_PARENTS, ADMIN_GROUP_PARENT_ADD, ADMIN_GROUP_PARENT_REMOVE,
